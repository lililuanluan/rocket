...
class TestStrategy(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Class-wide Mock for iteration_type."""
        cls.iteration_type = Mock()

    def test_init(self):
        """Test whether Strategy attributes get initialized correctly."""
        strategy = RandomFuzzer(iteration_type=self.iteration_type)
    ...
    def test_process_message_type_34(self):
        ...
        ledger_iter.start_timeout = MagicMock()
    ...
    def test_negative_process_message_type_34(self):
    ...
    def test_process_message_type_not_supported(self):
