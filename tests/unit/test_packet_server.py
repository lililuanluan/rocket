...
def test_get_config():
    ...
    assert response.base_port_ws_admin == mock_strategy.network_config.get("base_port_ws_admin")
    assert response.base_port_rpc == mock_strategy.network_config.get("base_port_rpc")
    assert response.number_of_nodes == mock_strategy.network_config.get("number_of_nodes")
